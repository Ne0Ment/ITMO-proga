...
public class ClientCommandExecutor implements CommandExecutor {
    ...
    public ClientCommandExecutor(BufferedReader reader, PrintWriter writer, ClientNetworkIOInterface networkIO) {
        ...
        commandMap.put("login", new LoginCommand(this.writer, this.reader, this.networkIO));
        commandMap.put("register", new RegisterCommand(this.writer, this.reader, this.networkIO));
        commandMap.put("logout", new LogoutCommand(this.writer, this.reader, this.networkIO));
    }
