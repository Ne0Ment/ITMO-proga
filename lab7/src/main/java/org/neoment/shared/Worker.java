...
public class Worker implements Comparable<Worker>, Serializable {
    ...
    public Worker(Long id, String name, Coordinates coordinates, LocalDateTime creationDate, Float salary, Date startDate, LocalDateTime endDate, Position position, Organization organization, Long creatorId) {
        this.id = id;
        this.name = name;
